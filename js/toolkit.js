...
/***/ function(module, exports, __webpack_require__) {
	...
	var _lodashThrottle = __webpack_require__(2);
	...
	document.addEventListener('DOMContentLoaded', function () {
	    ...
	    var postShareLinks = document.querySelector('.share-post[data-fixed-share-links]');

	    if (postShareLinks) {
	        (function () {
	            var postBody = document.querySelector('.post__body');
	            var status = null;
	            var shouldBeActive = isMediumBreakpoint();

	            window.addEventListener('scroll', (0, _lodashThrottle2['default'])(function () {
	            ...
	            window.addEventListener('resize', (0, _lodashThrottle2['default'])(function () {
